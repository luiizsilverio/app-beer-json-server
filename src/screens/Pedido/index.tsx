...
export function Pedido({ mesa, handleBack, handleConfirm = () => {} }: Props){
  ...
  function handleExclui(consumo: IConsumo) {
    ...
    if (consumo.fechou) {
      Alert.alert('Exclusão', 'Este consumo já foi registrado')
      return
    }
  ...
  function alteraConsumo(consumo: IConsumo) {
    if (consumo.fechou) {
      Alert.alert('ATENÇÃO', 'Este consumo já foi registrado')
      return
    }
